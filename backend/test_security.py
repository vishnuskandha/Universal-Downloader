...
def test_configured_frontend_origins_are_parsed_and_normalized():
...
def test_empty_frontend_configuration_uses_local_default():
...
def test_cors_does_not_allow_wildcard_origin():
    ...
    assert cors.kwargs["allow_origins"] == ALLOWED_ORIGINS
